# Analyses dosage response
## By Emiel Schoneveld

# General syntax ----
## Set working directory
setwd("C:/Users/RSCHONE/OneDrive - UvA/Promotie/Paper - dosage/Analysis/")
...
data_logs_old <- read_xlsx("C:/Users/RSCHONE/researchdrive/RICDE-FMG-3578-Flits-Tutorlezen (Projectfolder)/data_analyse/Oefendata logs Flits! Tutorlezen/logs_lessons_anonymous.xlsx")

## Student characteristics data
data_characteristics_old <- read_xlsx('C:/Users/RSCHONE/researchdrive/RICDE-FMG-3578-Flits-Tutorlezen (Projectfolder)/data_analyse/achtergrondgegevens/achtergrondgegevens.xlsx')[,-1]

## Student test data
data_wordreading_all <- read_xlsx('C:/Users/RSCHONE/researchdrive/RICDE-FMG-3578-Flits-Tutorlezen (Projectfolder)/data_analyse/toetsgegevens/data_toetsgegevens.xlsx')
